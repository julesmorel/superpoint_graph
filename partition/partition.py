...
sys.path.append("/home/jules/Project/superpoint_graph/partition/cut-pursuit/build/src")
sys.path.append("/home/jules/Project/superpoint_graph/partition/ply_c")
...
parser.add_argument('--dataset', default='test', help='s3dis/sema3d/your_dataset')
